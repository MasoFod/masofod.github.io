...
HOST = "masofod.github.io"
KEY = "236483dd4aab4a88a0e6a35be3996996"


def get_latest_posts(sitemap_path, n=30):
    # 解析 XML sitemap
    ...
    # 获取所有 URL
    urls = [
        (url.find("s:loc", namespaces).text, url.find("s:lastmod", namespaces).text)
